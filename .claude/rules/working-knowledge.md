...
- LLM pipelines fail open by default — no crash signal on bad output; prefer deterministic validators at boundary crossings over neural judges at the end [uses: 3] activated: 2026-04-27 from: [[wiki:fail-open-vs-fail-stop-in-llm-pipelines]]
